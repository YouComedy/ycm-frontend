...
window.Modernizr = function (a, b, c) {
    ...
    return e.addTest = function (a, b) {
        if (typeof a == "object")
            ...
            a = a.toLowerCase();
            if (e[a] !== c) return e;
            b = typeof b == "function" ? b() : b, typeof f != "undefined" && f && (g.className += " _" + (b ? "" : "no-") + a), e[a] = b
        }
        return e
    ...
    }, g.className = g.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (f ? " _js _" + t.join(" _") : ""), e
}(this, this.document), Modernizr.addTest("speechinput", function () {
...
}(document, window.Modernizr), Modernizr.addTest("json", !! window.JSON && !! JSON.parse);