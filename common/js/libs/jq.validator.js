        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "number": {
                    ...
                    "regex": /^[\-\+]?(([0-9]+)([\.,]([0-9]+))?|([\.,]([0-9]+))?)$/,
                    "alertText": "* Поле должно содержать только цифры"
                },
                "month": {
                    "regex": /^\d{1,2}$/,
                    "alertText": "* В году нет столько месяцев"
                },
                "year": {
                    "regex": /^19[3456789]\d$/,
                    "alertText": "* Не тот возраст"
                },
                "date": {
                	"regex": /^\d{4}[\/\-](0?[1-9]|1[012])[\/\-](0?[1-9]|[12][0-9]|3[01])$/,
                    "alertText": "* Неправильная дата (должно быть в ДД.MM.ГГГГ формате)",
                    "alertDay1": "* В месяце не бывает столько дней",
                    "alertDay2": "* Отрицательных дат не бывает",
                    "alertMonth1": "* В году не бывает столько месяцев",
                    "alertMonth2": "* Отрицательных дат не бывает",
                    "alertYear1": "* Вы - самый старый человек в мире!",
                    "alertYear2": "* Вы еще слишком молоды, увы :("
                },
                "ipv4": {
	 ...
	 var methods = {
		...
		*/
		hidePrompt: function() {
			...
			$(promptClass).fadeTo(options.fadeDuration || 100, 0.3, function() {
				$(this).parent('.formErrorOuter').remove();
				$(this).remove();
			});
			return this;
		...
		*/
		_funcCall: function(field, rules, i, options) {
			...
			var fn = $.validationEngine.customFunctions[functionName] || window[functionName] || options.customFunctions[functionName];
